...
export class CarritoRepository {
    ...
    agregarProducto = async (id_usuario, id_producto, cantidad) => {
        ...
        const result = await pool.query("INSERT INTO carrito_productos (id_carrito, id_producto, cantidad) VALUES ($1, $2, $3) RETURNING *", [id_carrito, id_producto, cantidad]);
    ...
    eliminarProducto = async (id_usuario, id_producto) => {
        ...
        const result = await pool.query("DELETE FROM carrito_productos WHERE id_carrito = $1 AND id_producto = $2 RETURNING *", [id_carrito, id_producto]);
        return result.rows[0];
    };
}
